...
| 4. Character portraits | `gen_characters.py` | Nano Banana 2 (1K) — all portraits render **in parallel** (they're independent) | `char_*.png` (locked refs) — only for characters the script USES | $0.08 each |
